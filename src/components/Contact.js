...
[Your Contact Number]`;
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-light text-slate-900 dark:text-white mb-4">
            Get In <span className="font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Touch</span>
          </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                    Pokuru, V.V.Pallem Mandal, SPSR Nellore, Andhra Pradesh
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl">
            ...
            {submitStatus === 'error' && (
              <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-red-800 dark:text-red-200 font-medium">Failed to send message. Please try again.</span>
                </div>
              </div>
            )}
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl ${
                  isSubmitting 
